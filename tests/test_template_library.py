...
from kraft.template_library import TemplateLibrary, TemplateLibraryError
from kraft.template_models import AgentTask, BuiltinAction, ForgeAction, GateNode

#: The design document's "Library components" and "Chain example" YAML,
#: copied verbatim -- the acceptance target for resolution.
DESIGN_TEMPLATES = Path(__file__).parent / "fixtures" / "templates_v1"
