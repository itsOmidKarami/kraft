"""A workspace work item's tasks: fan-out by repository and the policy each
repository runs under, and area setup before an area's test scope (Task 10).

Git is real (a root with one real submodule, `make_repo_with_submodule`); a
task's process is a spy wherever what it ran under is the question."""
