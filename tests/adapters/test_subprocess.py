"""`kraft.adapters.subprocess.run_task` -- one real child process per
session, its row, log, env, sandbox and process-group teardown. Reading a
session's result and exit files is test_subprocess_result_files.py."""
