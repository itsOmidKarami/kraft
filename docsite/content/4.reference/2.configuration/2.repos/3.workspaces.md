...
This page covers declaring a workspace and what it means for sandboxing and publication.

A workspace is a root repository with other repositories mounted in it as submodules. It is declared beside the `repos:` list, naming entries by `id`:
