...
what a chain, node, task, and gate are, see [Concepts](/guide/concepts).
...
| `policy` | This node's layer of the [policy](/reference/configuration#policyyaml-caps-budget-archiving). Safety settings only tighten. Operational values stay within the administrator's maxima. |
