...
[Why a permission gate](/guide/why-a-permission-gate).
...
[Agent harnesses](/reference/harnesses#how-each-harness-runs-unattended) for
...
[Configuration](/reference/configuration#policy-fields) for how the layers
combine.
