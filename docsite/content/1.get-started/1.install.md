...
To build Kraft from source, see [Contributing](/project/contributing).
...
This covers the uv and script installs only.
...
updated. Then run `/kraft:onboard` in a repo: it connects the repo, runs
`kraft admin init --repo` for a repo-scoped copy of the MCP setup, and checks
