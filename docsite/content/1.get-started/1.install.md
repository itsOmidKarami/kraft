---
title: Install
description: Install, verify, upgrade, and uninstall Kraft with uv, Homebrew, the install script, or from source.
---

Install Kraft with [uv](#uv), [Homebrew](#homebrew-macos), the
[install script](#install-script), or [from source](#from-source). Then run `kraft` to
