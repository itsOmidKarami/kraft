...
With Kraft [connected to your agent](/get-started/install#connect-your-agent),
open a session in the repo you want Kraft to work on, run `/kraft:onboard`, and
follow what it asks. It connects the repo and makes sure
