...
In Claude Code, install the Kraft plugin and open a session in the repo you want
Kraft to work on:
...
Follow what it asks. It connects the repo and makes sure Kraft knows how to set
it up and run its tests, so your first work item doesn't stop on a wrong guess.

For other agents, or to set it up without the plugin, see
[Connect your agent](/get-started/install#connect-your-agent).
