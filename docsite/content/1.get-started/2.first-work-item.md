...
Step 2 recommends `/kraft:onboard`. Steps 3 to 6 have slash commands as well:
...
**From Claude Code (recommended).** With the [Kraft plugin](/get-started/install#connect-your-agent)
installed, open a session in the repo you want Kraft to work on, run
`/kraft:onboard`, and follow what it asks. It connects the repo and makes sure
Kraft knows how to set it up and run its tests, so your first work item doesn't
stop on a wrong guess.

**From a terminal.** Inside the repo, run:
