...
rejecting do, and what a reviewer is shown at one. Backfilled from the design
documents named in each `origin:` line, without reading the tests or `src/kraft/`.
...
origin: docs/consolidated/01_conceptual_model.md §3.1
...
origin: docs/consolidated/02_orchestrator_core.md §4.1
...
enforced-by: tests/test_gates.py::test_walk_stops_at_first_gate
origin: docs/consolidated/02_orchestrator_core.md §4.2
...
origin: docs/consolidated/01_conceptual_model.md §3.5
...
origin: docs/consolidated/02_orchestrator_core.md
...
origin: docs/superpowers/specs/2026-09-04-sub-project-a-gate-diff-review-design.md §4
...
origin: docs/superpowers/specs/2026-09-04-sub-project-a-gate-diff-review-design.md §1
...
origin: docs/superpowers/specs/2026-09-04-sub-project-a-gate-diff-review-design.md §2
...
origin: docs/consolidated/01_conceptual_model.md §9
...
origin: docs/consolidated/02_orchestrator_core.md §10.2
